...
data = data[['match_id', 'venue', 'innings', 'batting_team', 'bowler', 'runs_off_bat', 'extras']]
length = data.shape[0]

file1 = open('bowl.csv', 'w', newline='')
writer = csv.writer(file1)
writer.writerow([ 'matchid', 'venue', 'innings', 'batting_team', 'bowler', 'runs'])
